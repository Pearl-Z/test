...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$12.3Bn", percentageChange: 34.22)
    let stat2 = StatisticModel(title: "Total Volume", value: "$2.5Tr")
    let stat3 = StatisticModel(title: "Market Cap", value: "$12.34Bn")
    let stat4 = StatisticModel(title: "Market Cap", value: "$12.34Bn", percentageChange: -12.32)
